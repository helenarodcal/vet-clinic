...
//    private final static double THIRTEEN_POINT_FIVE_PERCENT = 0.135;
    ...
    public WhenApplyingSalesTax(int quantity, String name, ProductCategory category, double unitPrice, double expectedRate, String expectedName, double expectedAmount) {
        this.quantity = quantity;
        this.name = name;
        this.category = category;
        this.unitPrice = unitPrice;
        this.expectedRate = expectedRate;
        this.expectedRateName = expectedName;
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
                ...
                {1, "training dogs", Books, 5.00, 0.0, "Zero", 0.00},
                {1, "pills", Medicine, 5.00, 0.0, "Zero", 0.00},
                {1, "rubber bone", Toys, 10.00, 0.23, "Standard",2.30},
                {1, "dog food", PetFood, 20.00, 0.23, "Zero", 4.60}
                });
    }
    @Test
